        ...
        <div className="about-section">
          <div className="about-container">
            <div className="about-content">
              <h2 className="about-title">About Pixan.ai</h2>
              <div className="about-text">
                <p>
                  Pixan.ai es una plataforma de desarrollo de aplicaciones web personalizadas 
                  que combina la potencia de la inteligencia artificial con el expertise en 
                  desarrollo moderno.
                </p>
                <p>
                  Transformamos ideas en soluciones digitales funcionales usando las últimas 
                  tecnologías como Next.js, React, y herramientas de IA para crear experiencias 
                  web excepcionales.
                </p>
                <p>
                  Desde aplicaciones empresariales hasta herramientas especializadas, 
                  cada proyecto es desarrollado con atención al detalle y enfoque en 
              ...
              <div className="about-features">
                <div className="feature">
                  ...
                  <p>Prototipado y desarrollo acelerado con tecnologías modernas</p>
                </div>
                <div className="feature">
                  <div className="feature-icon">🤖</div>
                  <h3>IA Integrada</h3>
                  <p>Aplicaciones potenciadas con inteligencia artificial</p>
                </div>
                <div className="feature">
                  <div className="feature-icon">💼</div>
                  <h3>Soluciones Empresariales</h3>
                  <p>Herramientas personalizadas para necesidades específicas de negocio</p>
                </div>
              </div>
            </div>
          </div>
