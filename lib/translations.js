  ...
  en: {
    ...
    landing: {
      ...
      services: {
        brainColab: {
          title: "Brain co-lab",
          description: "Collaborative AI workspace for advanced multi-model interactions."
        },
        chatMultiGenAI: {
          title: "Chat Multi GenAI",
          description: "Multi-LLM chat powered by Claude, OpenAI, Gemini, Perplexity, DeepSeek and Mistral."
        },
        llmValidation: {
          title: "LLM Validation Test",
          description: "One LLM responds, another validates and enhances. Visual AI collaboration with image generation."
        }
      }
    },
  ...
  es: {
    ...
    landing: {
      ...
      services: {
        brainColab: {
          title: "Brain co-lab",
          description: "Espacio de trabajo colaborativo de IA para interacciones multi-modelo avanzadas."
        },
        chatMultiGenAI: {
          title: "Chat Multi GenAI",
          description: "Chat multi-LLM impulsado por Claude, OpenAI, Gemini, Perplexity, DeepSeek y Mistral."
        },
        llmValidation: {
          title: "LLM Validation Test",
          description: "Una LLM responde, otra valida y mejora. Colaboración visual de IA con generación de imágenes."
        }
      }
    },
