...
const API_KEYS = {
  ...
  qwen: process.env.QWEN_API_KEY_ENCODED ? deobfuscate(process.env.QWEN_API_KEY_ENCODED) : '',
  deepseek: process.env.DEEPSEEK_API_KEY_ENCODED ? deobfuscate(process.env.DEEPSEEK_API_KEY_ENCODED) : '',
...
const PRICING = {
  ...
  qwen: {
    input: 0.0003 / 1000,  // $0.30 por millón de tokens de entrada
    output: 0.0006 / 1000, // $0.60 por millón de tokens de salida
...
const INITIAL_BALANCES = {
  ...
  qwen: parseFloat(process.env.QWEN_BALANCE || '100'),
